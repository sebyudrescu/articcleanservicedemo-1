...
const NotFound = () => {
  return (
    <main className="pt-32 pb-24">
      ...
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8 py-20">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            La pagina che cerchi potrebbe essere stata spostata o rimossa. Torna alla homepage per continuare la tua visita.
          </p>
