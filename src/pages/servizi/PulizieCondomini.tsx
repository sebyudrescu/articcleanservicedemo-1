...
import { pulizieCondominialiImage, pulizieCondominialiImageSmall } from '@/data/serviceImages';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
                Pulizie <span className="text-sky-700">Condomini</span> a Brescia
              </h1>
            ...
            <div>
              <LazyImage
                ...
                fallbackSrc={pulizieCondominialiImageSmall}
