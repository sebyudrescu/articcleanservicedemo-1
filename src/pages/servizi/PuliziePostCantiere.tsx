...
import { puliziePostCantiereImage, puliziePostCantiereImageSmall } from '@/data/serviceImages';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                <Hammer className="w-8 h-8 text-sky-700" />
                <span className="text-sky-800 font-semibold">Servizio Specializzato</span>
              </div>
              <h1 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
                Pulizie <span className="text-sky-700">Post-Cantiere</span>
              </h1>
            ...
            <div>
              <LazyImage
                ...
                width={960}
                height={816}
                fallbackSrc={puliziePostCantiereImageSmall}
